...
const Footer = () => {
    return (
        <footer className="bg-[#dcdcdc] background pb-28">
            <div className="flex justify-between w-[1300px] m-auto pt-40">
                <div className="w-339 h-134">
                    <div className=" flex">
                        <div className="h-134">
                            <img src={kelidLogo} className="" />
                        </div>
                ...
                <div className="flex justify-between w-65% text-[#8A8A8A]">
                    <div>
                        <h2 className="text-right font-bold text-16 mb-24 text-[#1E1E1E]">ابر پت شاپ</h2>
                        <a href="#" className="font-normal text-14 leading-10 block text-right">درباره ما</a>
                        <a href="#" className="font-normal text-14 leading-10 block text-right">مجله</a>
                        <a href="#" className="font-normal text-14 leading-10 block text-right">فرصت شغلی</a>
                        <a href="#" className="font-normal text-14 leading-10 block text-right">استخدام در هولدینگ</a>
                        <a href="#" className="font-normal text-14 leading-10 block text-right">باشگاه مشتریان</a>
                    </div>
                    <div>
                        <h2 className="text-right font-bold text-16 mb-24 text-[#1E1E1E]">پشتیبانی</h2>
                        <a href="#" className="font-normal text-14 leading-10 block text-right">راهنمای درج آگهی</a>
                        <a href="#" className="font-normal text-14 leading-10 block text-right">پرسش های متداول</a>
                        <a href="#" className="font-normal text-14 leading-10 block text-right">انتقادات و پیشنهادات</a>
                    </div>
                    <div>
                        <h2 className="text-right font-bold text-16 mb-24 text-[#1E1E1E]">اطلاعات قانونی</h2>
                        <a href="#" className="font-normal text-14 leading-10 block text-right">قوانین سایت</a>
                        <a href="#" className="font-normal text-14 leading-10 block text-right">اشتراک</a>
                        <a href="#" className="font-normal text-14 leading-10 block text-right">حریم خصوصی</a>
                    </div>
                    <div className="w-278">
                        <h2 className="text-right font-bold text-16 mb-24 text-[#1E1E1E]">تماس با ما</h2>
            ...
            <div className="w-[1300px] m-auto bg-[#6E6E6E] text-[#6E6E6E] h-1 block mt-114"></div>
            <div className="h-83 w-[1300px] pt-40 flex justify-between m-auto">
