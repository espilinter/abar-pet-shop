...
const Advertising = (props) => {
    ...
    return (
        <div className={`w-157 md:w-200 h-141 md:h-307 shadow-[0px_0px_8px_2px_rgba(0,0,0,0.12)] rounded-xl `}>
            <div className={`w-157 md:w-200 h-157 md:h-200 bg-[url('../assets/image/category.png')] rounded-t-xl `} />
            <div className="h-141 md:h-166 rounded-t-[16px] rounded-b-xl bg-white mt-[-60px] w-157 md:w-200 pt-8 px-16">
                ...
                <div className="167px flex mt-7 xl:mt-13">
                ...
                <div className="167px flex mt-7 md:mt-20 justify-between">
                    <div className="flex">
                ...
                <div className="w-125 md:w-168 bg-[#B9B9B9] h-1 mt-15"></div>
