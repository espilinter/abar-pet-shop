    ...
    return (
        <>
            <div className="w-400 h-300 rounded-[16px] bg-[rgba(255,255,255,0.01)] shadow-[0_0_8px_2px_rgba(0,0,0,0.12)] relative text-center py-16 px-21 ">
                ...
                <h4 className="mt-18 m-auto text-center">{props.item.name}</h4>
                <p className="mt-25 w-225 m-auto text-[#6D6E6D] font-bold">{props.item.comment}</p>
                <p className="absolute bottom-16 left-21 text-[#8A8A8A] text-10 font-normal">{props.item.date}</p>
            </div>
        </>
    );
}
