        ...
        <>
            <div className="w-90% m-auto pt-160">
                <div className="w-full flex gap-x-40">
                    <div className="flex m-auto justify-between w-20% mt-0 ">
                        <div className={`bg-white backdrop-blur-[2.5px] shadow-[0px_0px_8px_2px_rgba(0,0,0,0.12)] w-full sm:w-192 860:w-248 1200:w-310 h-135 sm:h-265 860:h-364 1200:h-[512px] rounded-[12px] p-12 1200:p-16 m-auto flex sm:inline-block justify-between`}>
                            ...
                            <button className="w-30% sm:w-98% h-36 sm:h-25 860:h-30 1200:h-38 text-[#728A2D] border rounded-[6px] border-[#728A2D] font-medium mt-8 860:mt-24 1200:mt-30 text-center text-12 860:text-16 self-end">09xxxxxxxxx</button>
                            <button className="w-30% sm:w-98% h-36 sm:h-25 860:h-30 1200:h-38 text-[#fff] border rounded-[6px] bg-[#728A2D] font-medium mt-8 860:mt-24 text-center text-12 860:text-16 self-end">اطلاعات بیشتر</button>
                            <div></div>
                        </div>
                    </div>
                    <div className="grid grid-cols-4 1750:grid-cols-6 gap-x-40 1500:gap-x-60 1600:grid-cols-5 1600:gap-x-25 gap-y-32 w-80%" style={{ direction: "ltr" }} >
