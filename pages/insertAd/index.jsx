    ...
    return (
        <>
            <div className="w-80% pt-160 m-auto">
                ...
                <div className="grid grid-cols-5 gap-x-20 gap-y-32 m-auto mt-60 mb-30">
                    ...
                    <div className="col-span-5 flex flex-col justify-start gap-y-4 gap-x-24">
                        ...
                        <textArea className="rounded-md border border-[#DCDCDC] bg-[#f4f4f4] p-12 h-50" value={description} onChange={descriptionChangeHandler} />
                    </div>
                    {/* <div className="col-span-5 flex flex-col justify-start gap-y-4 gap-x-24">
